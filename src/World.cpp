...
World::World(sf::RenderWindow &window, FontHolder &fonts)
    : mWindow(window), mWorldView(window.getDefaultView()), mFonts(fonts), mTextures(),
...
void World::loadTextures()
{
  ...
  mTextures.load(Textures::Avenger, "assets/textures/Avenger.png");

  mTextures.load(Textures::Bullet, "assets/textures/Bullet.png");
  mTextures.load(Textures::Missile, "assets/textures/Missile.png");

  mTextures.load(Textures::HealthRefill, "assets/textures/HealthRefill.png");
  mTextures.load(Textures::MissileRefill, "assets/textures/MissileRefill.png");
  mTextures.load(Textures::FireSpread, "assets/textures/FireSpread.png");
  mTextures.load(Textures::FireRate, "assets/textures/FireRate.png");
}
...
void World::adaptPlayerPosition()
{
  ...
  position.x = std::min(position.x, viewBounds.position.x + viewBounds.size.x -
                                        borderDistance);
  position.y = std::max(position.y, viewBounds.position.y + borderDistance);
  position.y = std::min(position.y, viewBounds.position.y + viewBounds.size.y -
                                        borderDistance);
...
void World::spawnEnemies()
{
  ...
  while (!mEnemySpawnPoints.empty() && mEnemySpawnPoints.back().y > getBattlefieldBounds().position.y)
  {
